...
public class SimpleInvocationResolver implements InvocationResolver {

	private final ApplicationClassSource app;
	
	public SimpleInvocationResolver(ApplicationClassSource app) {
		this.app = app;
	}
	...
	@Override
	public FieldNode findField(String owner, String name, String desc, boolean isStatic) {
		if(isStatic) {
