...
public abstract class IteratorIterator<T> implements Iterator<T> {
	...
	public static class CollectionIteratorIterator<T> extends IteratorIterator<T> {

		private final Iterator<? extends Collection<T>> it;
		
		public CollectionIteratorIterator(Collection<? extends Collection<T>> collections) {
