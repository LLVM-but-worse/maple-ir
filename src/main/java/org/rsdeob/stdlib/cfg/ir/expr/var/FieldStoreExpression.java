package org.rsdeob.stdlib.cfg.ir.expr.var;
...
public class FieldStoreExpression extends Expression {
	...
	public FieldStoreExpression(Expression instanceExpression, Expression valueExpression, String owner, String name, String desc) {
	...
	public Expression copy() {
		return new FieldStoreExpression(instanceExpression != null ? instanceExpression.copy() : null, valueExpression.copy(), owner, name, desc);
	}
	...
	public void toCode(MethodVisitor visitor) {
		...
		visitor.visitInsn(instanceExpression != null ? TypeUtils.getDupXOpcode(getType(), instanceExpression.getType()) : TypeUtils.getDupOpcode(getType()));
	...
	public boolean isAffectedBy(Statement stmt) {
		return stmt.canChangeLogic() || (instanceExpression != null && instanceExpression.isAffectedBy(stmt)) || valueExpression.isAffectedBy(stmt);
	}
}